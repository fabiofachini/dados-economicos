...
series = [
    ...
    {'url': 'https://apisidra.ibge.gov.br/values/t/6391/n1/all/v/5932/p/last%201/c888/all', 'tabela': 'rendimento_mensal_atividade', 'descricao': '6391: Rendimento médio mensal real das pessoas de 14 anos ou mais de idade ocupadas na semana de referência com rendimento de trabalho, habitualmente recebido no trabalho principal - Total - por grupamento de atividade no trabalho principal', 'unidade':'Milhões de Reais', 'periodicidade': 'T'},
